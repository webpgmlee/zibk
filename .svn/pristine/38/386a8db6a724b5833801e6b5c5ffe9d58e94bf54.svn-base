...
public class EmailDomain {
	...
	private String emailSeqno;
	private String untyCntrNo;
	private String emailRlDscd;
	...
	public String getEmailSeqno() {
		return emailSeqno;
	}
	public void setEmailSeqno(String emailSeqno) {
	...
	public String getEmailRlDscd() {
		return emailRlDscd;
	}
	public void setEmailRlDscd(String emailRlDscd) {
		this.emailRlDscd = emailRlDscd;
	}
