					...
					<tr onclick="fn_detail('${items.notiSeq}');" style="cursor: hand;">
						<td class="ellips">${no+seq.index}</td>
						 <c:choose>
                           ...
                           <td class="title al"><img src="/img/notice_icon${items.notiTypeCd}.${items.remk1}">&nbsp;${kbiz:getMaxString(items.notiTitle,56)}</td>
	                       </c:when>
	                       <c:otherwise>
                           <td class="ellips al"><img src="/img/notice_icon${items.notiTypeCd}.${items.remk1}">&nbsp;${kbiz:getMaxString(items.notiTitle,56)}</td>
	                       </c:otherwise>
	                   </c:choose>
