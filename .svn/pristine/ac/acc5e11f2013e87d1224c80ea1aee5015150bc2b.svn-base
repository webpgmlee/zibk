...
<script type="text/javascript">
       ...
       function fn_searchClick(){
        ...
        function fn_submit() {
           ...
           $("#mypageSearchForm").attr("action","/mypage/mypageList.view");
            KBIZIO.requestViewAjax("mypageSearchForm", "mypageListView", fn_submitCallback);
        }
      ...
      //인입채널 클릭 시
        function fn_selChnl(){
            ...
            KBIZIO.requestParamAjax("/mypage/mypageLcode.json", fn_lcodeCallback, {params: {chnlCode: checkedValue}});
       }
      ...
      //대분류 선택 시
        function fn_lcode(){
            ...
            KBIZIO.requestParamAjax("/mypage/mypageMcode.json", fn_mcodeCallback, {params: {chnlCode: checkedValue,lcode: lcodeValue}});
        }
        ...
        function fn_mcode(){
            ...
            KBIZIO.requestParamAjax("/mypage/mypageScode.json", fn_scodeCallback,options);
        }
        ...
        function fn_detail(seq,deSeq) {
            ...
            KBIZIO.requestParamAjax("/mypage/mypageDetail.json", fn_detailCallback, {params: {cnltSeq: seq,cnltDetailNo:deSeq}});
        }
...
<form id="mypageSearchForm" name="mypageSearchForm" method="post" action="/mypage/mypageList.view" onsubmit="return false;">
...
<div class="section">
    <div id="mypageListView"></div>
</div>
<div class="section"><h3><span class="sec_tit">상담이력 상세보기</span></h3></div>
<div id="mypageDetailJson">
    <form id="mypageDetailForm" name="mypageDetailForm" method="post" onsubmit="return false;">
        <input type="hidden" id="recUrl" name="recUrl" value=""/>
        <input type="hidden" id="loginCallApGrade" name="loginCallApGrade" value="${loginCallApGrade}"/>
