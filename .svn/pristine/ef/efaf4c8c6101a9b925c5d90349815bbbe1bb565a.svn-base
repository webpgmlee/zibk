...
public class ConsultController {
	...
	public String callbackList(@ModelAttribute CallbackDomain callbackDomain, Model model){
		...
		model.addAttribute("pageDomain", inboundService.selectCallbackTotalCnt(callbackDomain));
	...
	public void consultCallbackDetail(@ModelAttribute CallbackDomain callbackDomain, Model model){
		inboundService.callBackProc(callbackDomain);
	}
	...
	public void vocReg(@ModelAttribute VocDomain vocDomain, Model model){
		inboundService.vocReg(vocDomain);
		model.addAttribute("resultCode", vocDomain.getVocRstlCode());
	}
