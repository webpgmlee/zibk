<%--
 * file name    : mypageList.jsp
 * description  : MYPAGE상담이력
 * author       : 백소영
...
<%@ taglib prefix="kbiz" uri="/WEB-INF/tld/kbiz.tld" %>
    <h3><span class="sec_tit">상담이력</span></h3>
...
<div class="boardPagingWrap">
    <kbiz:pageNavi pageDomain="${pageDomain }" executeTargetFunction="fn_submit" submitTargetForm="mypageSearchForm" />
</div>