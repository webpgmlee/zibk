...
<head>
    ...
    <script type="text/javascript">
        ...
        function fn_detail(seq) {
        	...
        	KBIZIO.requestParamAjax("/admin/smsSendDetail.json", fn_detailCallback, {params: {sendSmsSeq: seq}});
        }
...
<form id="smsSendSearchForm" name="smsSendSearchForm" method="post" action="/admin/smsSendList.view" onsubmit="return false;">
