...
<div class="wrap">
	<div class="sch_wap">
		<c:if test="${startCon ne null}">
	    	<iframe name="custFrame" id="custFrame" src="/inbound/customer/custInfo.do?startCon=${startCon}" class="frame"></iframe>
	    </c:if>
	    <c:if test="${startCon eq null}">
	    	<iframe name="custFrame" id="custFrame" src="/inbound/customer/custInfo.do?startCon=" class="frame"></iframe>
	    </c:if>
    </div>
    <div class="container">
