<%--
 * file name    : channelStat.jsp
 * description  : 인입채널별 통계
 * author       : 백소영
...
<head>
    ...
    <script type="text/javascript">
        ...
        var list = KBIZIO.requestParamAjax("/admin/channelStatCodeList.json","",{ async: false});
       ...
       //조회
        function fn_submit() {
           ...
           if($("#selFromDt").val().length == 10){           //날짜가 정확하게 입력되었는지 검사
            ...
            KBIZIO.requestParamAjax("/admin/channelStatList.json", fn_submitCallback, {params : {selDate : selDate, selFromDt : selFromDt, selToDt : selToDt}, async: false});
        }
        ...
        function fn_submitCallback(ret) {
            ...
            var f_dataVal = [];
            for(var i =0;i<len;i++){
                f_dataVal[i] = r[i].fCnt;
            }
            var g_dataVal = [];
            for(var i =0;i<len;i++){
                g_dataVal[i] = r[i].gCnt;
            }
...
<div class="admin_content">
    <div class="template_wrap">
        <form id="channelStatSearchForm" name="channelStatSearchForm" method="post" action="/admin/cnltProcStatList.view" onsubmit="return false;">
            <div class="section">
                <h3><span class="sec_tit">인입채널별 검색</span></h3>
