...
<h3><span class="sec_tit">특이성향</span></h3>
    ...
    <table width="100%" border="0"  cellspacing="0" cellpadding="0" class="brd_list_a hover_action">
        ...
        <tbody>
           ...
           <c:forEach items="${resultList }" var="items">
                   ...
                   <td>${items.regNm }</td>
                   <td>${items.spclAppvUserNm }</td>
                   <td>${items.spclAppvYn }</td>
               </tr>
           </c:forEach>
           </c:if>
...
<div class="boardPagingWrap">
    <kbiz:pageNavi pageDomain="${pageDomain }" executeTargetFunction="fn_submit" submitTargetForm="specialSearchForm" />
</div>