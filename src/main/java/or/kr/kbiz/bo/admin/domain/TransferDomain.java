...
public class TransferDomain extends BaseDomain {
	...
	private String selTellNum;			//연락처
	private String selUserNm;			//고객명
	private String selCnltProcCd;		//처리구분
	private String selTranNm;			//처리자명
	...
	public String getSelTranNm() {
		return selTranNm;
	}

	public void setSelTranNm(String selTranNm) {
		this.selTranNm = selTranNm;
	}
